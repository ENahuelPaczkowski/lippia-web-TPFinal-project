...
public class HomePageConstants {
    ...
    public static final String CART_AMOUNT = "xpath://span[@class='amount']";
    public static final String TOTALS_TABLE = "xpath://*[@class='cart_totals ']/table";
    public static final String CHECKOUT_BUTTON = "xpath://*[contains(text(),'Proceed to Checkout')]";
    ...
    public static final String INPUT_POSTCOCE = "id:billing_postcode";
